...
public class DashboardController {
    ...
    @GetMapping("/sum")
    public RestBean<ReadingSumVO[]> sumList(){
        ReadingSumVO[] readingSumVOS = dashboardService.getSumReading();
        return RestBean.success(readingSumVOS);
    }

    @GetMapping("/recent")
    public RestBean<List<RecentReading>> recentList() {
        return RestBean.success(dashboardService.getRecentReadings());
    }
